...
export const sampleSkus: Sku[] = [
  {
    ...
    title:
      "PawJoy Dog Chew Toy Best Durable Tough Indestructible Chew Toys for Aggressive Chewers Large Dogs Puppy Teething Toy Non Toxic Rubber Bone Great Gift!!!",
    bullets: [
  ...
  },
  {
    ...
    category: "Pet Supplies > Dog Supplies > Chew Toys",
    title:
      "Benebone Wishbone Durable Dog Chew Toy for Aggressive Chewers, Real Bacon Flavor, Made in USA, Large",
    bullets: [
  ...
  },
  {
    ...
    category: "Pet Supplies > Dog Supplies > Chew Toys",
    title:
      "Nylabone Power Chew Textured Dog Chewing Toy, Chicken Flavor, Large Breed (1 Count)",
    bullets: [
    ...
    description:
      "Nylabone Power Chew toys are engineered for dogs that chew aggressively. The durable material is designed to stand up to tough chewing while the textured surface helps reduce plaque and tartar for better dental health. Infused with a long-lasting chicken flavor, this toy keeps dogs engaged and helps redirect chewing away from furniture and shoes. Available in multiple sizes to match your dog's breed and chew strength. As with any chew toy, supervise your dog during use and replace if the toy becomes damaged.",
    image_urls: [
  ...
  },
  {
    ...
    description:
      "The KONG Extreme is built for dogs who chew with serious power. Constructed from KONG's toughest rubber compound, it is designed to withstand heavy use over time. The hollow design lets you stuff the toy with treats, peanut butter, or KONG Easy Treat to turn chew time into an engaging mental workout. Recommended for large, powerful chewers. Always supervise dogs during play and replace the toy if it becomes damaged. Available in multiple sizes for dogs of all breeds.",
    image_urls: [
  ...
  },
  {
    ...
    brand: "FizzWave",
    category:
      "Grocery & Gourmet Food > Beverages > Bottled Beverages > Sparkling Water",
    title:
      "FizzWave Sparkling Water Natural Flavor Variety Pack 12 Cans BEST TASTING Zero Calorie Zero Sugar Zero Sodium Naturally Flavored Sparkling Water Drink Cans Pack of 12 CHEAP DEAL",
    bullets: [
    ...
    description:
      "FizzWave is here to change the sparkling water game forever! Our cans are packed with flavor and ZERO calories, ZERO sugar. Perfect for anyone on keto, diet, or just trying to be healthy. Cheapest price on Amazon, buy 2 packs and save even more! Great for the whole family. 5 star rated by our customers. Order now before this deal ends!",
    image_urls: ["https://images.ciq-demo.com/skus/CIQ-SPW-001-1.jpg"],
  },
  {
    sku_id: "COMP-SPW-101",
    is_client: false,
    ...
    category:
      "Grocery & Gourmet Food > Beverages > Bottled Beverages > Sparkling Water",
    title:
      "LaCroix Sparkling Water, Pamplemousse (Grapefruit), 12 Fl Oz (Pack of 12)",
    bullets: [
  ...
  },
  {
    ...
    category:
      "Grocery & Gourmet Food > Beverages > Bottled Beverages > Sparkling Water",
    title:
      "Spindrift Sparkling Water, Raspberry Lime Flavored, Made with Real Squeezed Fruit, 12 Fl Oz Cans, Pack of 12",
    bullets: [
